...
def demo():
    ...
    print(f"     • Has bearing/rotational components detected")
    print(f"     • Manufacturing method (SLA) suited for precision")
    print(f"     • BOM includes steel ball bearings")
    print()
    
    print(f"❌ DOWNRANKED: Part {loser['id']} ranked last (pop-it toy)")
    print(f"   Score: {loser['score']:.1f}/100")
    print(f"   Why it ranked lower:")
    print(f"     • Has pop/bubble features (anti-features for spinner)")
    print(f"     • No bearing/rotation components")
    print(f"     • Silicone-based (not typical for spinners)")
    print()
